...
RUN apt-get update && apt-get -y install php5-fpm php5-pgsql imagemagick postgresql-client supervisor nano lynx unzip
...
ADD https://github.com/kulttuuri/slack_mediawiki/archive/v1.06.zip /app/slack_mediawiki.zip
